...
const og = `<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630"><rect width="1200" height="630" fill="#F6F4EF"/><path d="M80 65H1120M80 535H1120" stroke="#DEDAD1"/>${letters(normal,'Maximilian',80,225,124,'#1C1B18')}${letters(italic,'Köhlenbeck',80,355,124,'#8F3614')}${letters(normal,'Automation. Robotics. Physical AI.',84,452,38,'#6A665E')}<rect x="880" y="125" width="240" height="330" fill="#1C1B18"/><path d="M895 377H1105M974 352H1026V374H974Z" fill="none" stroke="#ECE8DF" stroke-width="2"/><path d="M1000 352L1012 208" stroke="#E0703F" stroke-width="4"/><circle cx="1000" cy="352" r="4" fill="#ECE8DF"/></svg>`;
